...
function render() {
    ...
    snake.forEach((elm) => {
        blocks[`${elm.x}-${elm.y}`].classList.remove("fill");
    })
    ...
    snake.pop()
    snake.forEach((elm) => {
        blocks[`${elm.x}-${elm.y}`].classList.add("fill");
    })
...
addEventListener("keydown", (elm) => {

    if (elm.key === "ArrowUp") {
        diraction = "up";
    } else if (elm.key === "ArrowLeft") {
        diraction = "left";
    } else if (elm.key === "ArrowRight") {
        diraction = "right";
    } else if (elm.key === "ArrowDown") {
        diraction = "down";
    }
